...
MathUtility = {
     ...
     * */
    mapNumberToRange: function(s, f1, f2, t1, t2) {
        var slope = ((t2 - t1) / (f2 - f1));
     ...
     * @return {Array} items
     * */
    getBubbleSortedArray: function(items) {
     ...
     * */
    isPointInCircle: function(point, circlePosition, circleRadius) {
        var d = Math.sqrt((
     ...
     * */
    getEuclideanDistance2D: function(coord1, coord2) {
